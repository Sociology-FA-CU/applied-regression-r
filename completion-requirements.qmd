...
5.  Send both document to [ales\@vomacka.io](mailto:ales@vomacka.io) or [vomackaa\@ff.cuni.cz](mailto:vomackaa@ff.cuni.cz).

The due date for the report is 5th September so that we can grade it till 20th September (the last day when SIS is open for entries for the summer semester). We recommend that you try to submit earlier. And If you get stuck don’t be afraid to ask for a consultation!
